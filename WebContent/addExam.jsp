...
<body>
	<form action="addSchedule.do" method="post">
		<ul>
			<li>
				<b>구분</b><br> 
				<label><input type="radio" name="type" value="exam" checked >시험</label>
			</li>
			<li>
				<b>과목명</b><br> <input type="text" name="name" autofocus required> 
			</li>
			<li>
				<b>범위</b><br> <input type="text" name="content">
			</li>
			<li>
				<b>일시</b><br> <input type="datetime-local" name="date" required>
			</li>
		</ul>
